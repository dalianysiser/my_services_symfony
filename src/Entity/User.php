...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: ServiceHistory::class, mappedBy: 'user', orphanRemoval: true)]
    ...
    public function removeServiceHistory(ServiceHistory $serviceHistory): static
    {
        if ($this->serviceHistories->removeElement($serviceHistory)) {
            ...
            if ($serviceHistory->getUser() === $this) {
                $serviceHistory->setUser(null);
            }
        }
